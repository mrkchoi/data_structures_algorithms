function sortObject(arr, property, order) {
  // return sorted array, sort by property, either asc/desc

  return arr.sort((a,b) => {
    let ordering = order === 'asc' ? a[property] - b[property] : b[property] - a[property];
    return ordering;
  })
}
